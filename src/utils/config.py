...
__C.TRAIN_PATH.MODEL_NAME = utils.model_name(__C.TRAIN_PARAM.DATASET_SIZE, r'C:\Users\MS_BGD\PycharmProjects\facial_landmark_detection\models\mobilenet_v2\new')
